...
const questionsBank5 = [
    // Dimensión 0: Aptitud Técnica y Analítica
    [
        {
            question: "¿Qué experimentas al enfrentarte a un desafío lógico o matemático complejo?",
            options: [
                { text: "Me resulta abrumador y prefiero evitarlo", value: 1 },
                { text: "Lo intento, pero pierdo interés rápidamente", value: 3 },
                { text: "Puedo resolverlo con cierto esfuerzo", value: 6 },
                { text: "Disfruto el desafío y generalmente encuentro la solución", value: 8 },
                { text: "Me apasiona analizar y perfeccionar soluciones", value: 10 }
            ]
        },
        {
            question: "Cuando aprendes algo nuevo, ¿cuál es tu enfoque preferido?",
            options: [
                { text: "Sigo instrucciones sin profundizar", value: 1 },
                { text: "Comprendo lo básico antes de aplicarlo", value: 3 },
                { text: "Analizo el fundamento de cada concepto", value: 6 },
                { text: "Descompongo y reconstruyo el concepto desde sus principios", value: 8 },
                { text: "Lo aplico en proyectos prácticos mientras aprendo", value: 10 }
            ]
        },
        {
            question: "¿Cómo abordas un problema técnico que no conoces?",
            options: [
                { text: "Evito involucrarme en él", value: 1 },
                { text: "Busco ayuda de inmediato", value: 3 },
                { text: "Investigo soluciones fundamentales", value: 6 },
                { text: "Analizo las causas y pruebo diferentes alternativas", value: 8 },
                { text: "Diseño y documento mi propia solución", value: 10 }
            ]
        }
    ],
    ...
    [
        {
            question: "En un entorno grupal, ¿cuál suele ser tu actitud predominante?",
            options: [
                { text: "Prefiero trabajar de forma individual", value: 1 },
                { text: "Colaboro únicamente cuando me lo solicitan", value: 3 },
                { text: "Escucho activamente y comparto mi perspectiva", value: 6 },
                { text: "Procuro que todos se sientan incluidos y valorados", value: 8 },
                { text: "Me concentro en comprender y apoyar emocionalmente al grupo", value: 10 }
            ]
        },
        {
            question: "Si un amigo atraviesa por un momento difícil, tú...",
            options: [
                { text: "Mantengo distancia para no involucrarme", value: 1 },
                { text: "Le ofrezco espacio y espero que mejore", value: 3 },
                { text: "Escucho atentamente e intento animarle", value: 6 },
                { text: "Dedico tiempo y atención sincera a su situación", value: 8 },
                { text: "Empatizo profundamente y le acompaño activamente", value: 10 }
            ]
        },
        {
            question: "¿Qué relevancia tiene para ti comprender las emociones de los demás?",
            options: [
                { text: "No le concedo importancia", value: 1 },
                { text: "Solo cuando afecta directamente mis actividades", value: 3 },
                { text: "Intento hacerlo cuando tengo la oportunidad", value: 6 },
                { text: "Procuro comprender el contexto emocional en cada situación", value: 8 },
                { text: "Es esencial para establecer conexiones significativas", value: 10 }
            ]
        }
    ],
    ...
    [
        {
            question: "Ante el surgimiento de una nueva tecnología, tu reacción es...",
            options: [
                { text: "La ignoro hasta que sea imprescindible", value: 1 },
                { text: "La observo desde la distancia", value: 3 },
                { text: "La exploro con cierta precaución", value: 6 },
                { text: "Busco cómo aplicarla en mi entorno inmediato", value: 8 },
                { text: "La adapto creativamente y sugiero mejoras o nuevos usos", value: 10 }
            ]
        },
        {
            question: "¿Cuál es tu nivel de comodidad al utilizar herramientas de inteligencia artificial?",
            options: [
                { text: "Me generan desconfianza y escepticismo", value: 1 },
                { text: "Las utilizo solo cuando no existe otra alternativa", value: 3 },
                { text: "Las empleo con fines específicos y prácticos", value: 6 },
                { text: "Las integro activamente en mis actividades diarias", value: 8 },
                { text: "Exploro sus límites y comparto mi conocimiento con otros", value: 10 }
            ]
        },
        {
            question: "¿Cómo respondes ante los rápidos avances tecnológicos?",
            options: [
                { text: "Me generan ansiedad y prefiero lo conocido", value: 1 },
                { text: "Me cuesta adaptarme inicialmente", value: 3 },
                { text: "Aprendo gradualmente a medida que se presentan", value: 6 },
                { text: "Me adapto con curiosidad y entusiasmo", value: 8 },
                { text: "Anticipo estos cambios y los aprovecho estratégicamente", value: 10 }
            ]
        }
    ],
    ...
    [
        {
            question: "Al seleccionar una actividad o proyecto, prefieres...",
            options: [
                { text: "Máxima seguridad y rutina predecible", value: 1 },
                { text: "Poca variación y estabilidad constante", value: 3 },
                { text: "Un equilibrio entre riesgo y certidumbre", value: 6 },
                { text: "Desafíos que ofrezcan posibilidad de crecimiento", value: 8 },
                { text: "Alta incertidumbre si implica desarrollo personal", value: 10 }
            ]
        },
        {
            question: "¿Cómo reaccionas ante una oportunidad con resultados inciertos?",
            options: [
                { text: "No la considero como una opción viable", value: 1 },
                { text: "Solo la evalúo si ofrece garantías considerables", value: 3 },
                { text: "Analizo detenidamente ventajas y desventajas", value: 6 },
                { text: "La asumo si el potencial de éxito es elevado", value: 8 },
                { text: "La persigo con determinación, confiando en mis habilidades", value: 10 }
            ]
        },
        {
            question: "¿Qué tan cómodo te sientes al asumir riesgos en tus decisiones?",
            options: [
                { text: "Totalmente incómodo", value: 1 },
                { text: "Solo en situaciones altamente controladas", value: 3 },
                { text: "Depende de las circunstancias específicas", value: 6 },
                { text: "Cómodo si los beneficios potenciales justifican el riesgo", value: 8 },
                { text: "Disfruto tomar riesgos calculados e inteligentes", value: 10 }
            ]
        }
    ],
    ...
    [
        {
            ...
            options: [
                { text: "Al aire libre o en contacto con la naturaleza", value: 1 },
                { text: "En espacios tranquilos, silenciosos y cerrados", value: 3 },
                { text: "En un ambiente estructurado como un aula o estudio", value: 6 },
                { text: "En un entorno digital flexible y tecnológico", value: 8 },
                { text: "En cualquier lugar mientras pueda mantenerme conectado", value: 10 }
            ]
        },
        {
            question: "Tu espacio ideal para estudiar o trabajar es...",
            options: [
                { text: "Completamente aislado y sin distracciones", value: 1 },
                { text: "Controlado, ordenado y predecible", value: 3 },
                { text: "Colaborativo pero con un equilibrio adecuado", value: 6 },
                { text: "Tecnológicamente equipado y flexible", value: 8 },
                { text: "Híbrido, adaptable a diferentes contextos y necesidades", value: 10 }
            ]
        },
        {
            question: "¿Qué tipo de ambiente estimula tu creatividad e innovación?",
            options: [
                { text: "Uno estable, constante y sin cambios", value: 1 },
                { text: "Uno con estructura clara y definida", value: 3 },
                { text: "Espacios variados que puedo adaptar según la tarea", value: 6 },
                { text: "Entornos dinámicos, modernos y tecnológicos", value: 8 },
                { text: "Ambientes cambiantes que constantemente me desafían", value: 10 }
            ]
        }
    ],
    ...
    [
        {
            ...
            options: [
                { text: "Seguir instrucciones sin cuestionarlas", value: 1 },
                { text: "Participar de forma pasiva y reservada", value: 3 },
                { text: "Aportar ideas y contribuir al orden del grupo", value: 6 },
                { text: "Guiar mediante la escucha activa y coordinación", value: 8 },
                { text: "Motivar, inspirar y asumir responsabilidades", value: 10 }
            ]
        },
        {
            question: "¿Qué caracteriza mejor tu estilo de liderazgo?",
            options: [
                { text: "No me considero una persona con habilidades de liderazgo", value: 1 },
                { text: "Solo asumo el rol de líder cuando no hay otra opción", value: 3 },
                { text: "Busco la cooperación y consenso del equipo", value: 6 },
                { text: "Fomento la autonomía y una visión compartida", value: 8 },
                { text: "Transformo y desarrollo a las personas con las que trabajo", value: 10 }
            ]
        },
        {
            question: "Cuando surge un conflicto en tu grupo de trabajo o estudio, tú...",
            options: [
                { text: "Evitas involucrarte en la situación", value: 1 },
                { text: "Esperas que otra persona intervenga para resolverlo", value: 3 },
                { text: "Intentas mediar solo si te lo solicitan explícitamente", value: 6 },
                { text: "Intervienes con tacto y diplomacia", value: 8 },
                { text: "Tomas la iniciativa para restaurar la armonía grupal", value: 10 }
            ]
        }
    ],
    ...
    [
        {
            question: "¿Con qué regularidad aprendes algo nuevo por iniciativa propia?",
            options: [
                { text: "Nunca", value: 1 },
                { text: "Muy ocasionalmente", value: 3 },
                { text: "Periódicamente, cuando algo despierta mi interés", value: 6 },
                { text: "Con frecuencia, como parte de mi rutina", value: 8 },
                { text: "Constantemente, es una parte fundamental de mi vida", value: 10 }
            ]
        },
        {
            question: "Cuando algo cambia en tu ámbito de estudio o interés, tú...",
            options: [
                { text: "Muestras resistencia al cambio", value: 1 },
                { text: "Te adaptas con dificultad y lentitud", value: 3 },
                { text: "Aceptas gradualmente la novedad", value: 6 },
                { text: "Aprovechas el cambio como oportunidad de mejora", value: 8 },
                { text: "Te anticipas e impulsas nuevas formas de abordarlo", value: 10 }
            ]
        },
        {
            question: "¿Qué tan dispuesto estás a estudiar o capacitarte en nuevos temas?",
            options: [
                { text: "Nada dispuesto, prefiero mantenerme en mi zona de confort", value: 1 },
                { text: "Solo cuando es estrictamente necesario", value: 3 },
                { text: "Depende del tema y su relevancia para mí", value: 6 },
                { text: "Interesado si me aporta valor o conocimiento", value: 8 },
                { text: "Muy motivado, disfruto ampliando constantemente mis horizontes", value: 10 }
            ]
        }
    ],
    ...
    [
        {
            ...
            options: [
                { text: "La idea general y el concepto global", value: 1 },
                { text: "La coherencia y estructura del contenido", value: 3 },
                { text: "Errores o inconsistencias evidentes", value: 6 },
                { text: "Detalles menores y aspectos precisos", value: 8 },
                { text: "Cada mínimo aspecto, incluyendo formato y presentación", value: 10 }
            ]
        },
        {
            question: "¿Cómo describirías tu enfoque al realizar tareas que requieren precisión?",
            options: [
                { text: "Busco finalizar rápidamente", value: 1 },
                { text: "Reviso solo los aspectos esenciales", value: 3 },
                { text: "Soy cuidadoso con los pasos fundamentales", value: 6 },
                { text: "Verifico cada parte con atención meticulosa", value: 8 },
                { text: "Perfeccionista, no omito ningún detalle", value: 10 }
            ]
        },
        {
            question: "¿Qué tan importante es para ti la exactitud y precisión en tus actividades?",
            options: [
                { text: "No me preocupa especialmente", value: 1 },
                { text: "Solo cuando es estrictamente necesario", value: 3 },
                { text: "Es importante, pero sin llegar a obsesionarme", value: 6 },
                { text: "Muy importante en todas mis tareas", value: 8 },
                { text: "Es fundamental en todo lo que realizo", value: 10 }
            ]
        }
    ],
    ...
    [
        {
            ...
            options: [
                { text: "Sigo un método ya establecido y probado", value: 1 },
                { text: "Busco ejemplos similares para guiarme", value: 3 },
                { text: "Adapto ideas y soluciones ya conocidas", value: 6 },
                { text: "Combino conceptos de diferentes áreas", value: 8 },
                { text: "Creo una solución completamente original", value: 10 }
            ]
        },
        {
            question: "¿Qué significado tiene para ti la expresión creativa?",
            options: [
                { text: "No despierta mi interés", value: 1 },
                { text: "Solo como una forma de entretenimiento ocasional", value: 3 },
                { text: "Es importante, pero no esencial en mi vida", value: 6 },
                { text: "Es clave para sentirme realizado y satisfecho", value: 8 },
                { text: "Constituye una parte esencial de mi identidad", value: 10 }
            ]
        },
        {
            question: "¿Qué haces cuando una idea o proyecto no funciona como esperabas?",
            options: [
                { text: "La abandono y busco alternativas diferentes", value: 1 },
                { text: "Intento repetir el mismo enfoque varias veces", value: 3 },
                { text: "Busco realizar pequeñas mejoras incrementales", value: 6 },
                { text: "Cambio completamente el enfoque y experimento", value: 8 },
                { text: "Reinvento la idea desde sus fundamentos", value: 10 }
            ]
        }
    ],
    ...
    [
        {
            question: "¿Qué te motiva principalmente al elegir una actividad o proyecto?",
            options: [
                { text: "La recompensa material o reconocimiento", value: 1 },
                { text: "La estabilidad y seguridad que ofrece", value: 3 },
                { text: "El crecimiento y desarrollo personal", value: 6 },
                { text: "La oportunidad de ayudar a otras personas", value: 8 },
                { text: "La posibilidad de generar un cambio positivo en la sociedad", value: 10 }
            ]
        },
        {
            question: "¿Cómo defines el éxito en tus actividades personales o académicas?",
            options: [
                { text: "Alcanzar seguridad y reconocimiento económico", value: 1 },
                { text: "Ser reconocido por la calidad de mi trabajo", value: 3 },
                { text: "Tener un impacto positivo en quienes me rodean", value: 6 },
                { text: "Aportar valor constante a mi comunidad", value: 8 },
                { text: "Dejar un legado que mejore la vida de otros", value: 10 }
            ]
        },
        {
            question: "¿Qué tan importante es para ti contribuir al bienestar colectivo?",
            options: [
                { text: "No constituye una prioridad en mis intereses", value: 1 },
                { text: "Solo si no interfiere con mis objetivos personales", value: 3 },
                { text: "Me interesa hacerlo en la medida de lo posible", value: 6 },
                { text: "Intento aportar desde mis actividades diarias", value: 8 },
                { text: "Es el propósito central que guía mis acciones", value: 10 }
            ]
        }
    ]
];
